...
class M33AnalyticOrbit:
    ...
    def __init__(self, filename):
        ...
        self.Vc = 180  # circular speed in km/s (Halo Vcirc  Homework 5)
        
        ### Fudge factor ##  Start with 1.0 and then change to fit the orbit 
        self.fudge = 0.65 # 0.6
    ...
    def DynamicalFriction(self, Msat, Vc, r, v):
        """ Function that returns the deceleration from dynamical friction felt by M33
        ...
        Vc: `float`
            Max circular velocity of the host's dark matter halo (km/s)
...
if __name__ == '__main__':
    ...
    # Compute the orbit
    M33.OrbitIntegration(0, 0.1, 10.)  # timestep 0.1 default 
    ...
    ax.plot(M33Orbit_Hmwk7['t'], M31_M33_R_Hmwk7, 'b', lw=5, label='M31-M33 No DF')

    # Plot the simulated separation of M31 and M33
    ax.plot(M33SimOrbit['t'], M31_M33_SimR, 'r', lw=5, linestyle=":", label='M31-M33 Simulation')

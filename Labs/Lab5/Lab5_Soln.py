...
print(f" Mass to Light Ratio 47 Tuc: {np.around(massTuc/lumTuc,3)}")
...
# The stellar mass 
    ...
    def StellarMass(self):
        ...
        OUTPUT: float, stellar mass in Msun"""
...
# # Q1
# 
# In traditional models of the Magellanic Clouds (prior to 2010), the LMC is thought to have a halo mass of order $3 \times 10^{10}$ M$_\odot$.  According to LCDM theory, what should be the stellar mass of such a halo at z=0?  
# 
